                ...
                {news
                    ...
                    .map((item) => (
                        <Link href={item.link} key={item.id} target="_blank" rel="noopener noreferrer" className="block group h-full">
                            <Card className="glass-card h-full hover:shadow-xl transition-all duration-300 hover:-translate-y-1 border-t-4 border-t-transparent hover:border-t-primary">
                                <CardHeader>
                                    ...
                                    <CardTitle className="line-clamp-2 group-hover:text-primary transition-colors text-foreground">
                                        {item.title}
                                    </CardTitle>
                                </CardHeader>
                                <CardContent>
